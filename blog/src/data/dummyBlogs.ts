...
export const dummyCategories: BlogCategory[] = [
  ...
  { _id: "cat-philosophy", name: "Philosophy", icon: "book" },
  { _id: "cat-startup", name: "Entrepreneurship", icon: "rocket" },
];
...
const processUser = pipe(
  ...
  // ── 10. Teaching Coding ────────────────────────────────────────────
  {
    ...
    category: cat("cat-philosophy"),
    tags: ["Education", "Accessibility", "Community", "Neurodiversity"],
    readTime: "5 min read",
    isNew: false,
    likes: 47,
    likesCount: 47,
